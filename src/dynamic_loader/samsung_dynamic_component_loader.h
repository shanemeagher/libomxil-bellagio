/**
  src/slp_dynamic_component_loader.h
...
#ifndef SLP_DYNAMIC_COMPONENT_LOADER_H__
#define SLP_DYNAMIC_COMPONENT_LOADER_H__

#include "omxcore.h"
#include "extension_struct.h"

/** @brief the private data structure handled by the SLP dynamic loader that described
 ...
 * standard.
 */
typedef struct steLoaderComponentType{
...
/** @brief The constructor of the SLP specific component loader.
 *
 * It is the component loader developed under linux by Samsung, for local libraries.
